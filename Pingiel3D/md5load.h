...
class md5load
{
	...
	public:
		...
		void draw(float x, float y, float z, float scale,int a);
		void draw(float x, float y, float z, float scale, int a,int speedy);
     ...
     private:
		...
		GLuint modeltexture[255];
		GLuint modelshader[255];
		//variable definitions
		 md5_model_t md5file;
		 md5_anim_t md5anim[7];

		int animated;// = 0;
		
		md5_joint_t *skeleton[7];
		anim_info_t animInfo[7];
